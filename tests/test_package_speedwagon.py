...
from package_speedwagon import package_speedwagon
...
def test_get_license_get_result_of_first_successful_callable_skips_rest():
    ...
    result = package_speedwagon.get_license(
        strategies_list=[
...
class TestCreateLicenseTXTFile:
    def test_create_calls_write_file(self):
        ...
        strategy = package_speedwagon.CopyLicenseFile("License", output_path)
...
class TestCreateNoLicenseFile:
    def test_call_calls_write_license_file(self):
        output_path = os.path.join("dummy", "path", "license.txt")
        strategy = package_speedwagon.GenerateNoLicenseGivenFile(output_path)
...
class TestLocateLicenseFile:
    def test_call(self):
        strategy = package_speedwagon.LocateLicenseFile()
